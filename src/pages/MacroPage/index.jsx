...
const MacroPage = () => {
    ...
    const macros = {
        'Proteínas': 'Proteínas de alto valor biológico, são de origem animal e contêm todos os aminoácidos essenciais. Proteínas de baixo valor biológico, são de origem vegetal e contém menos aminoácidos essenciais. Vegetarianos devem variar as fontes de proteínas para obter todos os aminoácidos necessários.',
